...
from performance_review_db import (
    db_get_excel_file,
    db_get_all_excel_filepaths,
    db_remove_excel_file,
    db_clear_database,
)
...
def main(self):
    ...
    img = tk.PhotoImage(
            file=(os.path.abspath("gui_icon.png"))
        )
    self.root.tk.call("wm", "iconphoto", self.root._w, img)

    self.excel_index = 1

    self.import_sheet_button = Button(
        self.root,
    ...
    self.remove_sheet_button = Button(
        self.root,
    ...
    self.goto_report_loc_button = Button(
        self.root,
    ...
    self.generate_report_button = Button(
        self.root, text="Generate Reports", state="normal", command=self.generate_report
    )

    self.report_card_button = Button(
        self.root,
...
def init_widgits(self):
    ...
    self.excel_sheet_frame = ttk.Treeview(
        self.excel_sheet_frame,
    ...
    self.excel_sheet_frame.heading(
...
def import_spreadsheet_btn_click(self):
    ...
    try:
        ...
        for filename in filename_list:
            ...
            self.excel_sheet_frame.insert(
                parent="",
                index="end",
                iid=self.excel_index,
                text="",
